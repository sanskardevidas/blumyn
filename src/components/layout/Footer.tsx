  ...
  return (
    <footer className="relative isolate overflow-hidden border-t border-white/70 bg-[#FFF9FB]">
      ...
      <div className="mx-auto max-w-7xl px-4 py-10 sm:px-6 md:py-14">
        <div className="rounded-[2.5rem] border border-white/70 bg-white/58 p-6 shadow-[0_35px_100px_rgba(91,54,113,0.14)] backdrop-blur-2xl md:p-8">
          <div className="grid gap-8 md:grid-cols-4 md:gap-10">
            <div>
              ...
              <h3 className="mb-3 text-3xl font-semibold text-[#553268]">
                Blumyn
              </h3>

              <p className="max-w-xs text-sm leading-7 text-[#70537C]">
            ...
            <div>
              <h4 className="mb-4 text-lg font-semibold text-[#553268]">
                About
              </h4>

              <div className="space-y-3 text-sm text-[#70537C]">
                <Link
                  href="/"
              ...
              <div className="mb-5 flex flex-wrap gap-2">
                {[
                  ...
                  return (
                    <span
                      key={item.label}
                      className="flex items-center gap-2 rounded-full border border-[#E6D6F2] bg-[#FFF8FC]/80 px-4 py-2 text-sm text-[#70537C]"
                    >
                      <Icon size={14} className="text-[#6F3E8F]" />
                      {item.label}
                    </span>
                  );
                })}
          ...
          <div className="mt-9 border-t border-[#E6D6F2] pt-6 text-center text-sm text-[#70537C]">
